...
BEGIN
    ...
    WHERE [Id] = @EntryNodeId AND [EntryId] = @EntryId AND [EntryVersion] = @EntryVersion)
        BEGIN
    ...
    ELSE
        ...
        VALUES
            (@Id, @EntryId, @EntryVersion, @EntryNodeId, @Name, @Type, @Order, @ts, @ts, @Resource, @Description, @Visibility)
    END
END
GO