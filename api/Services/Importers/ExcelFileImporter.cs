...
namespace Wbs.Api.Services.Importers;

public class ExcelFileImporter : BaseExtractService
{
    private readonly ILogger<ExcelFileImporter> logger;

    public ExcelFileImporter(AppConfig config, ILogger<ExcelFileImporter> logger, ListDataService listDataService, ResourcesDataService resourceDataService) : base(config, listDataService, resourceDataService)
    {
        this.logger = logger;
    }
