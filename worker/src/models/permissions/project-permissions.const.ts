...
permissions[PROJECT_CLAIMS.TASKS.CREATE] = [ROLES.PM, ROLES.ADMIN, ROLES.APPROVER, ROLES.SME];
permissions[PROJECT_CLAIMS.TASKS.UPDATE] = [ROLES.PM];
permissions[PROJECT_CLAIMS.TASKS.DELETE] = [ROLES.PM];
