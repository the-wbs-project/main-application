...
export class RouterService {
  ...
  constructor(private readonly email: MailGunService) {
    ...
    this.router.get('/api/activity/:organization/:topLevelId', apiAuth, Http.activity.getByIdAsync);
    this.router.get('/api/activity/:organization/user/:userId', apiAuth, Http.activity.getByUserIdAsync);
    this.router.put('/api/activity/:organization/:dataType', apiAuth, Http.activity.putAsync);
    this.router.get('/api/lists/:name', apiAuth, Http.metadata.getListAsync);
    this.router.get('/api/projects/:organization/my', apiAuth, Http.project.getAllAsync);
    this.router.get('/api/projects/:organization/watched', apiAuth, Http.project.getAllWatchedAsync);
    this.router.get('/api/projects/:organization/byId/:projectId', apiAuth, Http.project.getByIdAsync);
    this.router.put('/api/projects/:organization/byId/:projectId', apiAuth, Http.project.putAsync);
    this.router.get('/api/projects/:organization/byId/:projectId/nodes', apiAuth, Http.projectNodes.getAsync);
    this.router.put('/api/projects/:organization/byId/:projectId/nodes/batch', apiAuth, Http.projectNodes.batchAsync);
    ...
    this.router.get('/api/discussions/:organization/:threadId', apiAuth, Http.discussions.getAsync);
