  ...
  async fetch(request, env) {
    ...
    <script id="edge_config" type="application/json">${JSON.stringify(
      ...
      newHeaders.set(
        ...
        `script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdnjs.cloudflare.com https://kit.fontawesome.com https://static.cloudflareinsights.com https://jam.dev https://www.datadoghq-browser-agent.com https://cdn.auth0.com; style-src 'self' 'unsafe-inline' data: https://fonts.googleapis.com https://cdnjs.cloudflare.com; img-src 'self' data: https://imagedelivery.net https://*.gravatar.com https://i2.wp.com/ https://cdn.auth0.com; connect-src 'self' data: https://logs.browser-intake-us5-datadoghq.com https://browser-intake-us5-datadoghq.com https://ka-p.fontawesome.com https://auth.pm-empower.com ${config.api_domain} https://rum.browser-intake-us5-datadoghq.com https://ai.pm-empower.com; font-src 'self' data: https://cdnjs.cloudflare.com https://fonts.gstatic.com; frame-src 'self' https://auth.pm-empower.com https://www.google.com; worker-src blob:;`
      );
