  ...
  async fetch(request, env) {
    ...
    <link rel="preconnect" href="${env.API_URL_EXTERNAL}" />`;
      ...
      const config = {
        ...
        can_test_ai: env.CAN_TEST_AI.split(","),
        environment: env.SITE_ENVIRONMENT,
        datadog_logs_client_token: env.DD_LOGS_CLIENT_TOKEN,
    ...
    <script id="edge_config" type="application/json">${JSON.stringify(
      ...
      newHeaders.set(
        ...
        `script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdnjs.cloudflare.com https://kit.fontawesome.com https://static.cloudflareinsights.com https://jam.dev https://www.datadoghq-browser-agent.com https://cdn.auth0.com; style-src 'self' 'unsafe-inline' data: https://fonts.googleapis.com https://cdnjs.cloudflare.com; img-src 'self' data: blob: https://imagedelivery.net https://*.gravatar.com https://i2.wp.com/ https://cdn.auth0.com; connect-src 'self' data: https://logs.browser-intake-us5-datadoghq.com https://browser-intake-us5-datadoghq.com https://ka-p.fontawesome.com https://auth.pm-empower.com ${config.api_domain} https://rum.browser-intake-us5-datadoghq.com https://ai.pm-empower.com; font-src 'self' data: https://cdnjs.cloudflare.com https://fonts.gstatic.com; frame-src 'self' https://auth.pm-empower.com https://www.google.com; worker-src blob:;`
      );
