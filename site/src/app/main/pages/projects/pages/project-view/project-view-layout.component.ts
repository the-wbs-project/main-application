...
@Component({
  ...
  imports: [CategoryIconPipe, CommonModule, FillElementDirective, FontAwesomeModule, ProjectChecklistModalComponent, ProjectNavigationComponent, RouterModule, TranslateModule]
})
