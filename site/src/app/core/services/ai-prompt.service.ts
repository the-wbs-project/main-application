import { LibraryEntry, LibraryEntryVersion } from '../models';
import { WbsNodeView } from '../view-models';
import { sorter } from './sorter.service';

export class AiPromptService {
  static libraryEntryDescription(
  ...
  static libraryEntryTaskDescription(
    entry: LibraryEntry | undefined,
    version: LibraryEntryVersion | undefined,
    ...
    let message: string[] = [
      `Can you provide me with a one paragraph description for a ${type} titled '${version.title}?`,
    ];
