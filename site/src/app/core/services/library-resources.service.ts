...
import { LibraryTaskActivityService } from './library-task-activity.service';
import { LibraryActivityService } from './library-activity.service';

@Injectable()
export class LibraryResourcesService {
  private readonly versionActivity = inject(LibraryActivityService);
  private readonly taskActivity = inject(LibraryTaskActivityService);
