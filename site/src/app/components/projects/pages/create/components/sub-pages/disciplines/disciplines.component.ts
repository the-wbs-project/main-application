...
export class DisciplinesComponent implements OnInit {
  ...
  ngOnInit(): void {
    const cats = this.store.selectSnapshot(MetadataState.disciplineCategories);
    ...
    this.store
      .select(ProjectCreateState.disciplines)
  ...
  nav(): void {
    ...
    this.store.dispatch(new DisciplinesChosen(ids));
  }
