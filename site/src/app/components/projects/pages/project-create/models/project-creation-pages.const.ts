export const PROJECT_CREATION_PAGES = {
  GETTING_STARTED: {
    number: 1,
  ...
  LIB_OR_SCRATCH: {
    number: 4,
    title: 'ProjectCreate.Lib_Hand_Title',
    description: 'ProjectCreate.Lib_Hand_Description',
  },
  //LIB_SEARCH: 5,
  NODE_VIEW: {
    number: 6,
    title: 'ProjectCreate.Wbs_Heir_Title',
    description: 'ProjectCreate.Wbs_Heir_Description',
  },
  PHASES: {
    number: 7,
