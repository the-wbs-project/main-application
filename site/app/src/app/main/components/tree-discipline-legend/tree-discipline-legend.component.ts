...
import { DisciplineListComponent } from '@wbs/dummy_components/discipline-list.component';
import { DisciplineSplitListComponent } from '@wbs/dummy_components/discipline-split-list.component';
